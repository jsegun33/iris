                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <?php if ( trim(Auth::user()->AccountNo) == '2019-0001'  ){ ?>
					 <?php
                        ...
                        <?php  if  ($GetSubMenus['type_ID'] ==='5db9155e51e2332470006d42' ) {   //for quotation?>
                        
                            <li class="treeview menu-open" style="height: auto;">
                                <a href="#"><?php if ( !empty($GetSubMenus['icon_display'])) {?><i class="{{ $GetSubMenus['icon_display'] }}"></i><?php }?>{{ $GetSubMenus['type_name'] }}
                                  <span class="pull-right-container">
                                ...
                                <ul class="treeview-menu" style="display: block;">
                                  ...
                                  <li class="treeview">
                                    {{-- <a href="#"><i class="fa fa-circle-o"></i> Level Two111 --}}
                                        <?php 
                                        ...
                                        $GetSubMenu = DB::table('type_sub_link')
                                            ...
                                            //->where('type_ID',trim($GetRoles['_id']) ) 
                                            //->where('type_name',trim($GetRoles['type_name']) ) 
                                            ->where('UnderSubMenu',$GetSubMenus['type_ID'])
                                            ->where('active', 1)
                                        ...
                                        <li><router-link to="#"> <?php if ( !empty($GetSubMenus['icon_display'])) {?><i class="{{ $GetSubMenus['icon_display'] }}"></i><?php }?>{{ $GetSubMenus['SubLink_TypeName'] }}
                                        <?php }  ?>
                    ...
                    <?php
                        ...
                        $GetRole = DB::table('type')
                            ->select('*')  
                            ->where('_id', "5e377cdd51e233240c006fa3")  
                            ->where('active',1)  
                            //->groupBy('_id')  
                            ->get();
                    ...
                    <?php
                                ...
                                $GetRole = DB::table('user_roles')
                                    ...
                                    ->where('AccountNo', Auth::user()->AccountNo)  
                                    ->where('active', '1')  
                                    ->groupBy('acctTypeName','acctType')  
                                    ->get();

                    foreach ($GetRole as $GetRoles){
                                    //echo $GetRoles['acctType'] ;
                    ...
                    <a href="#">
                        <?php if ( !empty($GetRoles['icon_display'])) {?>
                         ...
                         <?php  }  ?> 
                        <span>{{ $GetRoles['acctTypeName'] }}</span>
                        <span class="pull-right-container">
                        <span class="label label-primary pull-right"></span>
                        </span>
                    </a>
                    ...
                    $GetSubMenu = DB::table('user_role_access')
                            ...
                            ->where('active', "1")
                            ->where('status', "1")
                            //->groupBy('AccountNo','acctTypeSub','role_number-url','role_name-access')  
                            ->get();
                    ...
                    ?>
                        ...
                        <li><router-link to="{{ $GetSubMenus['role_number_url'] }}"><?php if ( !empty($GetSubMenus['icon_display'])) {?><i class="{{ $GetSubMenus['icon_display'] }}"></i><?php }?>{{ $GetSubMenus['role_name_access'] }}</router-link></li>
                        <?php }  ?>
                    </ul>
