            ...
            <form @submit.prevent="">
                <div class="box-body">
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                <label for="name">UW Total Task :</label> 
                                 <input v-model="form.UWTotalTask"  type="number" class="form-control"  required>
                           </div>
                        </div>
                         <div class="col-md-2">
                            <div class="form-group">
                                <label for="name"> UW Daily Task :</label> 
                                 <input v-model="form.UWDailyTask"  type="number" class="form-control"   required>
                                 <small>set 1 to start assigned task</small>
                           </div>
                        </div>
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                <label for="name"> Comm.Activate :</label> 
                                 <input v-model="form.CommActivate"  type="number" class="form-control" >
                                 <small>set 1 to Activate Comm</small>
                           </div>
                        </div>
                </div>
                <div class="row">
        ...
        LoadUsersProfileView() {
                 ...
                 axios.get("api/UserProfileView/" + PassID).then(({ data }) => {
                    ...
                    result.map(detail => {
                            ...
                            if (detail.user_mname){
                                    UserMI = detail.user_fname + " " + detail.user_mname  + " " + detail.user_lname
                            }else{
                                    UserMI = detail.user_fname +  " " + detail.user_lname
                            }

                                    this.form.AccountNo     =  detail.AccountNo;
                                    this.form.AccountName   =  UserMI;
                                    ...
                                    this.form.UWDailyTask =  detail.UWTaskCounterDaily;
                                    this.form.UWTotalTask =  detail.UWTaskCounter;
                                    this.form.select_department1  =  detail.department;
                                    this.form.CommActivate  =  detail.CommActivate;
