...
export default {
    ...
    methods: {
        AutoLoad() {
            ...
            axios
                .get("api/GetPerilsCoverageAmountByDefault/")
            ...
            axios.get("api/PolicyModificationEditBtn/" + PassID).then(({ data }) => (this.URLQueryPerilsCoveragesGroup = data));
            //When ADD is CLICK
            axios
        ...
        SubmitNewCoverages() {
            ...
            this.form
                .post("api/SubmitNewCoveragesModification")
                .then(() => {
                    // Success!
                    // this.load()
        ...
        load() {
            ...
            this.ResultQueryRequest.data.map(ResultRequestDetailss => {
                ...
                this.form.DepreciativeAmount =
                    ...
                    this.form.RequestModify =   ResultRequestDetailss.RequestModify;
