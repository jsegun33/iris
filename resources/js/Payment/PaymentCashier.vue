<template>
    <div id="MainPage" > 
        ...
        <section class="content"  v-if="this.ResultQueryRequest.PaymentMode  === '0' && this.ResultQueryRequest.PaymentGateway  === '0' && this.AllRolesList ==='YES ACCESS'" >
                <div class="box-header with-border box box-success" id="quotehead" >
                      <div class="row">
                    <div class="col-md-12">
        ...
        <section class="content" v-if="this.ResultQueryRequest.PaymentGateway ==='Paypal' || form.PaymentModeOptions ==='Paypal' && this.AllRolesList ==='YES ACCESS'">
            <div class="row">
                <div class="col-md-12">
        ...
        <section class="content" v-if="form.PaymentMode=='PayMaya' && this.AllRolesList ==='YES ACCESS'">
            <div class="row">
                <div class="col-md-12">
         ...
         <section class="content"  v-if="this.ResultQueryRequest.PaymentGateway  === 'Dragonpay' || form.PaymentModeOptions=='Dragonpay' && this.AllRolesList ==='YES ACCESS'">
           ...
           <!-- -----------<pre>{{ $data }}</pre>--------- -->
             ...
             <section class="content"  v-if="this.ResultQueryRequest.PaymentGateway  === 'Cashier' || form.PaymentModeOptions=='Cashier' && this.AllRolesList ==='YES ACCESS'">
             <!-- <section class="content"> -->
             <form @submit.prevent="" > 
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table style="width:100%" >
											...
											<tr>
											  <th> </th><th> </th>
                                                <th  class="no-print" > 
                                                     <button type="button" class="btn btn-warning" @click='PaymentModeCashier()' >Pay @ the Cashier Counter : {{form.AmountDue | peso }} </button>
                                                 </th>
...
export default {
 mounted: function(){ 
        ...
        axios.get("api/URLQueryRequestModifyOld/" + PassID ) .then(({ data }) => (this.ResultQueryRequest = data)  );
        this.LoadDataRequest(); 
        this.StartLoading();
          this.form.NewRequestNo  = PassID ; 
    },
	 data() {
        return {
            ResultQueryRequest:{},
  ...
  async StartLoading() {
      ...
      PaymentModeCashier() {
          Swal.fire({
                ...
                confirmButtonText: "Yes, Pay Now...!"
                    ...
                    if (result.value) {
            if ( this.ResultQueryRequest.PaymentGateway  === '0'){ 
                   this.form.post('api/PaymentModeCashier').then(() => {     
                         let timerInterval
                          Swal.fire({
                          title: '<h3>Payment to Cashier</h3>',
                          html: 'Pls. Proceed to the CASHIER COUNTER for Payment with Request NO.: ' + this.form.RequestNo   ,
                          timer: 5000,
                          timerProgressBar: true,
                          allowOutsideClick: false,
                          allowEscapeKey: false,
                          ...
                          onClose: () => {
                              clearInterval(timerInterval)
                               this.$router.push('/Unpaid-Policies'); 
                          }
                          }).then((result) => {
                        ...
                        //          }
                          ...
                          this.form.post('api/PaymentModeCashierUpdate').then(() => {
                                this.$router.push("/cashier_return?"+ this.form.RequestNo1);
     ...
     LoadDataRequest() {
        this.RetrieveTimeInterval = setInterval(() => {
                    ...
                    this.form.PaymntDescription     = "Payment for the  Plate No. " + this.ResultQueryRequest.PlateNumber + " with Assured Name :" +  this.ResultQueryRequest.CName ;
