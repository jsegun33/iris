                                ...
                                <div class="col-md-12" v-if="form.CoveragesStatus[URLQueryPerilsCoveragesGroups.OptionNo] == 1" >
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control input-sm" @mouseover='LoadApprover(URLQueryPerilsCoveragesGroups)' v-model="form.ListApprover[URLQueryPerilsCoveragesGroups.OptionNo]" >
   ...
   mounted: function(){ 
    ...
    methods: {
         ...
         //alert(TotalCoverages);
                    ...
                    axios.get("api/PolicyAmountForModification/" + PassID ) .then(({ data }) => (this.URLQueryPerilsCoveragesGroup = data)  );
           },
