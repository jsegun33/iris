                                ...
                                <div class="col-md-12" v-if="form.CoveragesStatus[URLQueryPerilsCoveragesGroups.OptionNo] == 1" >
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group no-print">
                                            ...
                                            <select class="form-control input-sm no-print" @mouseover='LoadApprover(URLQueryPerilsCoveragesGroups)' v-model="form.ListApprover[URLQueryPerilsCoveragesGroups.OptionNo]" >
                                        ...
                                        <div class="form-group no-print" v-if="parseFloat(form.TxtCoverageAmount[URLQueryPerilsCoveragesGroups.OptionNo])">
