            ...
            <div class="col-md-6" v-for="URLQueryPerilsCoveragesGroups in URLQueryPerilsCoveragesGroup" :key="URLQueryPerilsCoveragesGroups._id" >
                <div class="box box-solid">
                    ...
                    <div class="box-body" id="proposalBody" >
                        ...
                        <div class="row" v-if="URLQueryPerilsCoveragesGroups.StatusCovetages != 3 || URLQueryPerilsCoveragesGroups.StatusCovetages != 4">
                             <div class="col-md-12">
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                <td  style="text-align:right;text-decoration-line: overline;text-decoration-style: double;font-style: italic;">{{  URLQueryPerilsCoveragesGroups.TotalPremium | Peso }} </td>
                                                 ...
                                                 <tr> <!---------TOTAL AMOUNT--------------------->
                                                    ...
                                                    <th style="text-align:right;text-decoration-line: underline;text-decoration-style: double;font-style: italic;" >{{ URLQueryPerilsCoveragesGroups.TotalAmountDue | Peso}}</th>
                                                </tr>
                    ...
                    <form @submit.prevent=""> 
                        ...
                        <input type="hidden"  v-model="form.Accessories"  >
                            ...
                            <div class="row text-center"   v-if="(form.QuoteExpiryStatus == 1 || form.QuoteExpiryStatus == 3) && URLQueryPerilsCoveragesGroups.StatusCovetages === 3"    >
                                <!-- <button class="btn btn-lg btn-success" @click='QueryByOPtion()'  @mouseover="QueryByOPtion1($event)"  :value="URLQueryPerilsCoveragesGroups.OptionNo + ';;' + URLQueryPerilsCoveragesGroups.RequestNo + ';;' + form.RemarksCustomer[URLQueryPerilsCoveragesGroups.OptionNo]"    > ACCEPT    </button>
                                <br> -->
                                <button type="button" class="btn btn-lg btn-success"  @mouseover="QueryByOPtion1($event)"  :value="URLQueryPerilsCoveragesGroups.OptionNo + ';;' + URLQueryPerilsCoveragesGroups.RequestNo + ';;' + form.RemarksCustomer[URLQueryPerilsCoveragesGroups.OptionNo]" data-toggle="modal" data-target="#acceptModal">
                                    Accept  
                                </button>
                                <br>
